 ...
 * @LastEditors: Gin
 * @LastEditTime: 2021-06-24 14:01:58
 */
...
module.exports = [
  ...
  },
  {
    ...
    type: 'get',
    response: () => {
      return { 'code': 200, 'data': [{ 'id': 1, 'systemName': '创新人才首年生活补贴' }, { 'id': 2, 'systemName': '大学生见实习补贴' }, { 'id': 3, 'systemName': '姑苏重点产业紧缺人才计划' }, { 'id': 4, 'systemName': '已发布' }, { 'id': 5, 'systemName': '优秀人才贡献奖' }, { 'id': 6, 'systemName': '高等院校、科研院所引才补贴' }, { 'id': 7, 'systemName': '企业通过人才中介机构招财引智的引才补贴' }], 'msg': '', 'identifier': '' }
    }
  },
  {
